...
application = defines.get("app", "dist/PeppermintLauncher.app")  # noqa: F821
...
filename = 'PeppermintLauncher-macos-x86.dmg'

# Uncomment to override the output volume name
volume_name = 'PeppermintLauncher'
